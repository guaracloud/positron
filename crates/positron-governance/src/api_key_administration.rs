...
fn tenant_key_revocation_replay(
    catalog: &Catalog<'_>,
    tenant: TenantId,
    idempotency: AdministrativeIdempotencyKey,
    actor: PrincipalId,
