...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-cursor", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-sql-page-resume", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-cursor-replay", |fixture| {
...
fn correlation_cursor_resumes_after_both_signal_stores_reopen() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-cursor-restart", |fixture| {
...
fn correlation_target_frontier_cleanup_surfaces_a_release_failure() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-frontier-cleanup", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-missing-pair-binding", |fixture| {
        ...
        let failure = service.resume(fixture.context, &tampered).expect_err(
            "paired replay must reject an authenticated cursor without its target binding",
        );
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("ordinary-cursor-rejects-paired-binding", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-invalid-target-lease-identity", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-frontier-binding", |fixture| {
        fixture.kernel.append_trace([0xb5; 16], [0xb6; 8], 20, 1)?;
        fixture
            .kernel
            .append_log_with_trace("first", 20, [0xb5; 16], [0xb6; 8], 2)?;
