...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-matched", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-trace-id-only", |fixture| {
...
fn correlation_does_not_match_a_different_span_in_the_same_trace() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-wrong-span", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-sealed-active", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-ambiguous", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-sorted-outcomes", |fixture| {
