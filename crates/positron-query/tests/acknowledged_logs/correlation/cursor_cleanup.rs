...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-source-frontier-overflow", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-source-frontier-target-release", |fixture| {
        for (trace_id, span_id, time, identity, body) in [
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-source-frontier-wrong-target", |fixture| {
        for (trace_id, span_id, time, identity, body) in [
