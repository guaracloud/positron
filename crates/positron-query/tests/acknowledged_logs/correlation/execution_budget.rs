...
{
    QueryFixture::scoped("correlation-output-matched", |matched| {
        ...
        QueryFixture::scoped("correlation-output-missing", |missing| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-cumulative-budget", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-scan-exhaustion", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-scan-bytes-exhaustion", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-scan-cancellation", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-cpu-budget", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-target-cancel", |fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-aggregate-admission", |fixture| {
        let service = fixture.correlation_service(16)?;
...
fn correlation_fails_closed_on_malformed_target_trace_data() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("correlation-malformed-trace", |fixture| {
