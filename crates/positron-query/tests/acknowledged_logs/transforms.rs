...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("query-json-transform", |fixture| {
        fixture
            .kernel
...
{
    QueryFixture::scoped("query-json-transform-expansion", |fixture| {
        let source = format!(
            "[{}]",
...
fn logfmt_query_transform_decodes_quoted_and_typed_fields() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("query-logfmt-transform", |fixture| {
        fixture
            .kernel
...
{
    QueryFixture::scoped("query-transform-unicode-json", |fixture| {
        fixture
            .kernel
        ...
        QueryFixture::scoped("query-transform-unicode-logfmt", |logfmt_fixture| {
...
-> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("query-cast-transform", |fixture| {
