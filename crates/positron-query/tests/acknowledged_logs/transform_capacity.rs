...
fn parser_scratch_and_retained_output_have_exact_memory_boundaries() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("query-json-transform-memory-boundary", |json_fixture| {
        ...
        QueryFixture::scoped("query-logfmt-transform-memory-boundary", |logfmt_fixture| {
...
-> Result<(), Box<dyn Error>> {
    ...
    QueryFixture::scoped("query-json-array-simultaneous-capacity", |fixture| {
...
{
    QueryFixture::scoped("query-json-nested-parser-memory-boundary", |fixture| {
...
fn cast_string_peak_uses_retained_capacity_for_1024_records() -> Result<(), Box<dyn Error>> {
    QueryFixture::scoped("query-cast-string-capacity-boundary", |fixture| {
