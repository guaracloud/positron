...
/// A checked nonzero public API major version.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct ApiVersion(core::num::NonZeroU32);

impl ApiVersion {
    /// Canonical Release 1 API package.
    pub const V1: Self = Self(core::num::NonZeroU32::MIN);

    /// Creates a checked API major, rejecting the invalid zero value.
...
impl CapabilityService {
    ...
    pub const fn negotiate(request: CapabilityRequest) -> CapabilityResponse {
        let version_refusal = match ApiVersion::from_major(request.api_major) {
            Ok(version) if version.major() == ApiVersion::V1.major() => None,
