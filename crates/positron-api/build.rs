...
pub enum TenantRetentionServiceClientFailure {{ InvalidRequest, AuthenticationRejected, TenantUnavailable, InvalidConfirmation, StaleGeneration {{ retention_generation: u64, semantic_diff: String }}, IdempotencyConflict, AdministrationUnavailable, Transport }}
...
#[derive(Clone,Copy,Debug,Eq,PartialEq)] pub enum TenantServiceClientFailure {{ InvalidRequest, AuthenticationRejected, TenantUnavailable, StaleGeneration, IdempotencyConflict, AdministrationUnavailable, Transport }}
