...
pub(super) fn generate_policy_preview_client(
    operations: &ValidatedOperations,
) -> Result<(), Box<dyn Error>> {
    let operation = operations.operation("positron.v1.PolicyService/Validate")?;
...
"#,
    ...
    write_generated("policy_preview_service_client.rs", source)
}
